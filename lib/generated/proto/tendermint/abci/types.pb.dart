...
import '../types/types.pb.dart' as $22;
import '../crypto/proof.pb.dart' as $17;
import '../types/params.pb.dart' as $23;
import '../crypto/keys.pb.dart' as $24;
...
class RequestInitChain extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RequestInitChain', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.abci'), createEmptyInstance: create)
    ..aOM<$19.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'time', subBuilder: $19.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $19.Timestamp get time => $_getN(0);
  @$pb.TagNumber(1)
  set time($19.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearTime() => clearField(1);
  @$pb.TagNumber(1)
  $19.Timestamp ensureTime() => $_ensure(0);
...
class RequestBeginBlock extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RequestBeginBlock', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.abci'), createEmptyInstance: create)
    ...
    ..aOM<$22.Header>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: $22.Header.create)
  ...
  @$pb.TagNumber(2)
  $22.Header get header => $_getN(1);
  @$pb.TagNumber(2)
  set header($22.Header v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasHeader() => $_has(1);
  @$pb.TagNumber(2)
  void clearHeader() => clearField(2);
  @$pb.TagNumber(2)
  $22.Header ensureHeader() => $_ensure(1);
...
class ResponseQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResponseQuery', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.abci'), createEmptyInstance: create)
    ...
    ..aOM<$17.ProofOps>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofOps', subBuilder: $17.ProofOps.create)
  ...
  @$pb.TagNumber(8)
  $17.ProofOps get proofOps => $_getN(6);
  @$pb.TagNumber(8)
  set proofOps($17.ProofOps v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasProofOps() => $_has(6);
  @$pb.TagNumber(8)
  void clearProofOps() => clearField(8);
  @$pb.TagNumber(8)
  $17.ProofOps ensureProofOps() => $_ensure(6);
...
class ConsensusParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConsensusParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.abci'), createEmptyInstance: create)
    ...
    ..aOM<$23.EvidenceParams>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evidence', subBuilder: $23.EvidenceParams.create)
    ..aOM<$23.ValidatorParams>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validator', subBuilder: $23.ValidatorParams.create)
    ..aOM<$23.VersionParams>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $23.VersionParams.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ConsensusParams({
    BlockParams? block,
    $23.EvidenceParams? evidence,
    $23.ValidatorParams? validator,
    $23.VersionParams? version,
  }) {
    final _result = create();
    if (block != null) {
      _result.block = block;
  ...
  @$pb.TagNumber(2)
  $23.EvidenceParams get evidence => $_getN(1);
  @$pb.TagNumber(2)
  set evidence($23.EvidenceParams v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEvidence() => $_has(1);
  @$pb.TagNumber(2)
  void clearEvidence() => clearField(2);
  @$pb.TagNumber(2)
  $23.EvidenceParams ensureEvidence() => $_ensure(1);

  @$pb.TagNumber(3)
  $23.ValidatorParams get validator => $_getN(2);
  @$pb.TagNumber(3)
  set validator($23.ValidatorParams v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValidator() => $_has(2);
  @$pb.TagNumber(3)
  void clearValidator() => clearField(3);
  @$pb.TagNumber(3)
  $23.ValidatorParams ensureValidator() => $_ensure(2);

  @$pb.TagNumber(4)
  $23.VersionParams get version => $_getN(3);
  @$pb.TagNumber(4)
  set version($23.VersionParams v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasVersion() => $_has(3);
  @$pb.TagNumber(4)
  void clearVersion() => clearField(4);
  @$pb.TagNumber(4)
  $23.VersionParams ensureVersion() => $_ensure(3);
}
...
class ValidatorUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidatorUpdate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.abci'), createEmptyInstance: create)
    ..aOM<$24.PublicKey>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubKey', subBuilder: $24.PublicKey.create)
  ...
  @$pb.TagNumber(1)
  $24.PublicKey get pubKey => $_getN(0);
  @$pb.TagNumber(1)
  set pubKey($24.PublicKey v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPubKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearPubKey() => clearField(1);
  @$pb.TagNumber(1)
  $24.PublicKey ensurePubKey() => $_ensure(0);
...
class Evidence extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Evidence', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.abci'), createEmptyInstance: create)
    ...
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'height')
    ..aOM<$19.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'time', subBuilder: $19.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $19.Timestamp get time => $_getN(3);
  @$pb.TagNumber(4)
  set time($19.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearTime() => clearField(4);
  @$pb.TagNumber(4)
  $19.Timestamp ensureTime() => $_ensure(3);
