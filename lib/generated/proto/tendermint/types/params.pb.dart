...
class EvidenceParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EvidenceParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ...
    ..aOM<$21.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxAgeDuration', subBuilder: $21.Duration.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxNum', $pb.PbFieldType.OU3)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proofTrialPeriod')
    ..hasRequiredFields = false
  ;
  ...
  factory EvidenceParams({
    ...
    $21.Duration? maxAgeDuration,
    $core.int? maxNum,
    $fixnum.Int64? proofTrialPeriod,
  }) {
    final _result = create();
    ...
    if (proofTrialPeriod != null) {
      _result.proofTrialPeriod = proofTrialPeriod;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $21.Duration get maxAgeDuration => $_getN(1);
  @$pb.TagNumber(2)
  set maxAgeDuration($21.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxAgeDuration() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxAgeDuration() => clearField(2);
  @$pb.TagNumber(2)
  $21.Duration ensureMaxAgeDuration() => $_ensure(1);

  @$pb.TagNumber(3)
  $core.int get maxNum => $_getIZ(2);
  @$pb.TagNumber(3)
  set maxNum($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $fixnum.Int64 get proofTrialPeriod => $_getI64(3);
  @$pb.TagNumber(4)
  set proofTrialPeriod($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasProofTrialPeriod() => $_has(3);
  @$pb.TagNumber(4)
  void clearProofTrialPeriod() => clearField(4);
}
