...
final $typed_data.Uint8List dataDescriptor = $convert.base64Decode('CgREYXRhEhAKA3R4cxgBIAMoDFIDdHhzEhIKBGhhc2gYAiABKAxSBGhhc2g=');
...
const Commit$json = const {
  ...
  '2': const [
    ...
    const {'1': 'bit_array', '3': 6, '4': 1, '5': 11, '6': '.tendermint.libs.bits.BitArray', '10': 'bitArray'},
  ],
};

/// Descriptor for `Commit`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List commitDescriptor = $convert.base64Decode('');
