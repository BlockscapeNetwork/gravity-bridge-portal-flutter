...
import '../version/types.pb.dart' as $18;
import '../../google/protobuf/timestamp.pb.dart' as $19;
import '../libs/bits/types.pb.dart' as $20;
...
class Part extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Part', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ...
    ..aOM<$17.Proof>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proof', subBuilder: $17.Proof.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $17.Proof get proof => $_getN(2);
  @$pb.TagNumber(3)
  set proof($17.Proof v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProof() => $_has(2);
  @$pb.TagNumber(3)
  void clearProof() => clearField(3);
  @$pb.TagNumber(3)
  $17.Proof ensureProof() => $_ensure(2);
}
...
class Header extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Header', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..aOM<$18.Consensus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $18.Consensus.create)
  ...
  @$pb.TagNumber(1)
  $18.Consensus get version => $_getN(0);
  @$pb.TagNumber(1)
  set version($18.Consensus v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasVersion() => $_has(0);
  @$pb.TagNumber(1)
  void clearVersion() => clearField(1);
  @$pb.TagNumber(1)
  $18.Consensus ensureVersion() => $_ensure(0);
...
class Vote extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Vote', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestamp', subBuilder: $19.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $19.Timestamp get timestamp => $_getN(4);
  @$pb.TagNumber(5)
  set timestamp($19.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTimestamp() => $_has(4);
  @$pb.TagNumber(5)
  void clearTimestamp() => clearField(5);
  @$pb.TagNumber(5)
  $19.Timestamp ensureTimestamp() => $_ensure(4);
...
class Commit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Commit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hash', $pb.PbFieldType.OY)
    ..aOM<$20.BitArray>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bitArray', subBuilder: $20.BitArray.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $20.BitArray get bitArray => $_getN(5);
  @$pb.TagNumber(6)
  set bitArray($20.BitArray v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasBitArray() => $_has(5);
  @$pb.TagNumber(6)
  void clearBitArray() => clearField(6);
  @$pb.TagNumber(6)
  $20.BitArray ensureBitArray() => $_ensure(5);
}
...
class CommitSig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CommitSig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestamp', subBuilder: $19.Timestamp.create)
  ...
  @$pb.TagNumber(3)
  $19.Timestamp get timestamp => $_getN(2);
  @$pb.TagNumber(3)
  set timestamp($19.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTimestamp() => $_has(2);
  @$pb.TagNumber(3)
  void clearTimestamp() => clearField(3);
  @$pb.TagNumber(3)
  $19.Timestamp ensureTimestamp() => $_ensure(2);
...
class Proposal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Proposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.types'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestamp', subBuilder: $19.Timestamp.create)
