...
import '../../crypto/multisig/v1beta1/multisig.pb.dart' as $25;
import '../../base/v1beta1/coin.pb.dart' as $9;

import '../signing/v1beta1/signing.pbenum.dart' as $26;
...
class TxBody extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TxBody', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..pc<$12.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messages', $pb.PbFieldType.PM, subBuilder: $12.Any.create)
    ...
    ..pc<$12.Any>(1023, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extensionOptions', $pb.PbFieldType.PM, subBuilder: $12.Any.create)
    ..pc<$12.Any>(2047, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nonCriticalExtensionOptions', $pb.PbFieldType.PM, subBuilder: $12.Any.create)
    ..hasRequiredFields = false
  ;

  TxBody._() : super();
  factory TxBody({
    $core.Iterable<$12.Any>? messages,
    $core.String? memo,
    $fixnum.Int64? timeoutHeight,
    $core.Iterable<$12.Any>? extensionOptions,
    $core.Iterable<$12.Any>? nonCriticalExtensionOptions,
  }) {
    final _result = create();
    if (messages != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$12.Any> get messages => $_getList(0);
  ...
  @$pb.TagNumber(1023)
  $core.List<$12.Any> get extensionOptions => $_getList(3);

  @$pb.TagNumber(2047)
  $core.List<$12.Any> get nonCriticalExtensionOptions => $_getList(4);
}
...
class SignerInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignerInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$12.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: $12.Any.create)
  ...
  @$pb.TagNumber(1)
  $12.Any get publicKey => $_getN(0);
  @$pb.TagNumber(1)
  set publicKey($12.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPublicKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearPublicKey() => clearField(1);
  @$pb.TagNumber(1)
  $12.Any ensurePublicKey() => $_ensure(0);
...
class ModeInfo_Single extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModeInfo.Single', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..e<$26.SignMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: $26.SignMode.SIGN_MODE_UNSPECIFIED, valueOf: $26.SignMode.valueOf, enumValues: $26.SignMode.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $26.SignMode get mode => $_getN(0);
  @$pb.TagNumber(1)
  set mode($26.SignMode v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ModeInfo_Multi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModeInfo.Multi', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$25.CompactBitArray>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bitarray', subBuilder: $25.CompactBitArray.create)
  ...
  @$pb.TagNumber(1)
  $25.CompactBitArray get bitarray => $_getN(0);
  @$pb.TagNumber(1)
  set bitarray($25.CompactBitArray v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBitarray() => $_has(0);
  @$pb.TagNumber(1)
  void clearBitarray() => clearField(1);
  @$pb.TagNumber(1)
  $25.CompactBitArray ensureBitarray() => $_ensure(0);
