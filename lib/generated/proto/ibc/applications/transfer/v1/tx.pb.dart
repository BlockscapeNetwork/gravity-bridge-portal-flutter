...
import '../../../core/client/v1/client.pb.dart' as $32;
...
class MsgTransfer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgTransfer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.applications.transfer.v1'), createEmptyInstance: create)
    ...
    ..aOM<$9.Coin>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'token', subBuilder: $9.Coin.create)
    ...
    ..aOM<$32.Height>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeoutHeight', subBuilder: $32.Height.create)
  ...
  @$pb.TagNumber(3)
  $9.Coin get token => $_getN(2);
  @$pb.TagNumber(3)
  set token($9.Coin v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasToken() => $_has(2);
  @$pb.TagNumber(3)
  void clearToken() => clearField(3);
  @$pb.TagNumber(3)
  $9.Coin ensureToken() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $32.Height get timeoutHeight => $_getN(5);
  @$pb.TagNumber(6)
  set timeoutHeight($32.Height v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTimeoutHeight() => $_has(5);
  @$pb.TagNumber(6)
  void clearTimeoutHeight() => clearField(6);
  @$pb.TagNumber(6)
  $32.Height ensureTimeoutHeight() => $_ensure(5);
